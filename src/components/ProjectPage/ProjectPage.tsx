  ...
  <div className="group h-full relative flex flex-col bg-gray-900/50 border border-gray-700/60 rounded-xl overflow-hidden transition-all duration-300 hover:border-cyan-400/50 hover:shadow-2xl hover:shadow-cyan-500/10 animate-slide-in-up">
    ...
    <div className="relative overflow-hidden">
      {videoUrl ? (
        <video
          ...
          onError={(e) => {
            e.currentTarget.poster =
              "https://placehold.co/600x400/0a0a0a/ffffff?text=Video+Error";
          }}
        >
        ...
        <img
          ...
          onError={(e) => {
            e.currentTarget.src =
              "https://placehold.co/600x400/0a0a0a/ffffff?text=Project";
          }}
        />
      )}
    ...
    <div className="p-6 flex flex-col flex-grow">
      ...
      <p className="text-gray-500 text-xs mb-4">
        ...
        <span className="font-semibold">Timeframe:</span> {timeframe}
      </p>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {tags.map((tag) => (
          <span
            key={tag}
            className="text-xs font-semibold text-cyan-300 bg-cyan-900/60 px-3 py-1 rounded-full animate-fade-in"
          >
            {tag}
          </span>
        ))}
...
const VideoShowcase = ({ videos }: VideoShowcaseProps) => (
  <div className="mb-16 animate-fade-in">
    ...
    <p className="max-w-2xl mx-auto text-gray-400 mb-12 text-center">
      Leveraging AI tools like Steve.AI and Runway, I create engaging animations
      and promotional videos, streamlining the production process and enhancing
      visual storytelling.
    </p>
...
const ProjectHeader = () => (
  <div className="text-center mb-16 animate-fade-in">
    ...
    <p className="max-w-2xl mx-auto text-gray-400 mb-4">
      Explore my work in web development and AI-driven content creation. Using
      tools like Steve.AI and Runway, I’ve crafted animations and videos that
      enhance storytelling, saving up to 50% of production time while achieving
      professional results.
    </p>
    <p className="max-w-2xl mx-auto text-gray-400">
      Filter by category to dive into my projects, from interactive web apps to
  ...
  const videos = [
    {
      ...
      description:
        "A promotional animation created with Steve.AI, showcasing my portfolio’s UI transitions and responsive design.",
      url: "/Segment_2.mp4",
    },
    {
      title: "AI Showcase",
      description:
        "A short reel built with Runway, highlighting interactive web components and Tailwind CSS animations.",
      url: "/Segment_1.mp4",
    },
  ];
