      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {tags.map((tag) => (
            <span
              key={tag}
              className="text-xs font-semibold text-cyan-300 bg-cyan-900/50 px-2 py-1 rounded-full"
            >
              {tag}
            </span>
          ))}
    ...
    <div className="bg-[#0a0a0a] text-white font-sans">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-[100vh]">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-extrabold mb-4">
            <span className="text-gray-400">
              I'm <ColourfulText text="Nitin Singh" />.
            </span>
            <br />A <ColourfulText text="Front-End" /> Developer.
          </h1>
          <p className="max-w-xl text-gray-300 text-lg md:text-xl mb-8">
            ...
            applications. My passion lies in turning complex problems into
          ...
          <div className="grid md:grid-cols-5 gap-8 lg:gap-16 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <p className="text-gray-400 mb-4 leading-relaxed">
                Hello! I'm a passionate developer based in India with a strong
                focus on the MERN stack (MongoDB, Express.js, React, Node.js). I
                enjoy bringing ideas to life in the browser and continuously
                learning about new technologies.
              </p>
              <p className="text-gray-400 mb-6 leading-relaxed">
                When I'm not coding, you can find me exploring the latest trends
                in UI/UX design, contributing to open-source projects, or
        ...
        <footer className="py-8 border-t border-gray-800/50 text-center text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} Nitin Singh. All Rights Reserved.
          </p>
        </footer>
      </div>
    </div>
